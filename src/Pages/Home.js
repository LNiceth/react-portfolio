...
import Pdf from "../assets/pdf/lordnicethcuevas.pdf";
          ...
          <div className="col-sm-5">
            <div className="imgsec">
              <img
                src={profileimg}
                data-aos="flip-right"
                alt="Lord Niceth Cuevas"
                className="img-fluid"
              />
              <div className="socialmedia">
                <a
                  href="https://www.linkedin.com/in/lord-niceth-cuevas-243860238/"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img
                ...
                <a
                  href="mailto:lordnicethcuevas@gmail.com"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img
